...
float Ki = 0.0;          // Integral gain (helps eliminate steady-state error by considering the accumulated error over time)
float Kd = 6000.0;       // Derivative gain (reacts to the rate of change of the error, helping dampen oscillations)
...
const unsigned long SAMPLE_TIME = 8; // Sample time for the loop in milliseconds (5ms = 200Hz)
